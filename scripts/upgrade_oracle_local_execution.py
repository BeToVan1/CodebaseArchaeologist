"""Pinned local-execution evidence release; default is read-only preflight.
...
import upgrade_oracle_secret_screening as previous
from upgrade_oracle_workers_ai_diagnostics import real_analysis

updater = previous.updater
OLD_IMAGE = previous.NEW_IMAGE
NEW_IMAGE = 'sha256:bffade606742f89ccee058aed950110e413380581db5631cf7f8c769b5f9937b'
OLD_UNIT = previous.NEW_UNIT
NEW_UNIT = OLD_UNIT.replace(OLD_IMAGE, NEW_IMAGE)
BACKUP = updater.common.CONFIG / 'pre-local-execution-v1.service'
