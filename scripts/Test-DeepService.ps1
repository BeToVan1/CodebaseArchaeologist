...
$contextFiles = @(
    ...
    'analyzer.py', 'project_discovery.py', 'test_project_discovery.py', 'repository_loader.py', 'snapshot_capture.py', 'evidence_store.py', 'interpretation_evidence.py', 'workers_ai_client.py', 'deep_analysis_worker.py', 'deep_service.py', 'deep_quota.py', 'test_deep_quota.py',
    'api.py', 'interpretation.py', 'test_analyzer.py', 'test_local_execution_facts.py', 'test_architecture_acceptance.py', 'test_test_proximity.py', 'test_repository_loader.py',
    'test_api.py', 'test_interpretation.py', 'test_workers_ai_client.py', 'test_interpretation_evidence.py', 'test_evidence_store.py', 'test_snapshot_capture.py', 'test_deep_worker.py', 'test_deep_service.py',
